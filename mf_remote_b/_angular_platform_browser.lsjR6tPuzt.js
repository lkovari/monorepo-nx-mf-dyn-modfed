import { a as _, b as S, c as m, d as D, e as I, f as ee, g as T } from "@nf-internal/chunk-BXK7CII3";
import { a as H, e as R } from "@nf-internal/chunk-JKOY2XUY";
import { \u0275DomAdapter as te, \u0275setRootDomAdapter as ne, \u0275parseCookieValue as re, \u0275getDOM as j, DOCUMENT as B, CommonModule as oe, XhrFactory as ie, \u0275PLATFORM_BROWSER_ID as se } from "@angular/common";
import * as l from "@angular/core";
import { \u0275global as f, \u0275RuntimeError as ae, InjectionToken as it, ApplicationModule as ce, \u0275INJECTOR_SCOPE as ue, ErrorHandler as U, RendererFactory2 as le, \u0275TESTABILITY_GETTER as de, Testability as b, \u0275TESTABILITY as fe, \u0275internalCreateApplication as x, createPlatformFactory as pe, platformCore as me, PLATFORM_ID as he, PLATFORM_INITIALIZER as ge, \u0275resolveComponentResources as st, \u0275setDocument as Ee } from "@angular/core";
...
function we(t, o, e) { return R(this, null, function* () { let n = H({ rootComponent: t }, z(o, e)); return x(n); }); }
function Re(t, o) { return R(this, null, function* () { return x(z(t, o)); }); }
...
function Ie() { return new U; }
function be() { return Ee(document), document; }
var V = [{ provide: he, useValue: se }, { provide: ge, useValue: De, multi: !0 }, { provide: B, useFactory: be }], Ce = pe(me, "browser", V);
var G = [{ provide: de, useClass: w }, { provide: fe, useClass: b }, { provide: b, useClass: b }], Y = [{ provide: ue, useValue: "root" }, { provide: U, useFactory: Ie }, { provide: m, useClass: S, multi: !0 }, { provide: m, useClass: F, multi: !0 }, T, I, D, { provide: le, useExisting: T }, { provide: ie, useClass: _e }, []], Ae = (() => { class t {
    constructor() { }
    static \u0275fac = function (n) { return new (n || t); };
    static \u0275mod = l.\u0275\u0275defineNgModule({ type: t });
    static \u0275inj = l.\u0275\u0275defineInjector({ providers: [...Y, ...G], imports: [oe, ce] });
} return t; })();
import { \u0275getDOM as $, DOCUMENT as v } from "@angular/common";
import { \u0275getDOM as Ft } from "@angular/common";
import * as c from "@angular/core";
import { \u0275global as J, ApplicationRef as Oe, InjectionToken as W, Injector as Le, Optional as Ne, \u0275Console as ht, \u0275RuntimeError as C, SecurityContext as p, \u0275allowSanitizationBypassAndThrow as g, \u0275unwrapSafeValue as E, \u0275_sanitizeUrl as ke, \u0275_sanitizeHtml as He, \u0275bypassSanitizationTrustHtml as Pe, \u0275bypassSanitizationTrustStyle as je, \u0275bypassSanitizationTrustScript as Be, \u0275bypassSanitizationTrustUrl as Ue, \u0275bypassSanitizationTrustResourceUrl as xe, makeEnvironmentProviders as Fe, \u0275withDomHydration as ze, \u0275withEventReplay as Ve, \u0275withI18nSupport as Ge, \u0275withIncrementalHydration as Ye, ENVIRONMENT_INITIALIZER as _t, inject as Tt, \u0275IS_ENABLED_BLOCKING_INITIAL_NAVIGATION as Mt, \u0275formatRuntimeError as wt, Version as Je } from "@angular/core";
...
var We = { pan: !0, panstart: !0, panmove: !0, panend: !0, pancancel: !0, panleft: !0, panright: !0, panup: !0, pandown: !0, pinch: !0, pinchstart: !0, pinchmove: !0, pinchend: !0, pinchcancel: !0, pinchin: !0, pinchout: !0, press: !0, pressup: !0, rotate: !0, rotatestart: !0, rotatemove: !0, rotateend: !0, rotatecancel: !0, swipe: !0, swipeleft: !0, swiperight: !0, swipeup: !0, swipedown: !0, tap: !0, doubletap: !0 }, L = new W(""), Q = new W(""), Xe = (() => { class t {
    ...
    static \u0275inj = c.\u0275\u0275defineInjector({ providers: [{ provide: m, useClass: qe, multi: !0, deps: [v, L, Le, [new Ne, Q]] }, { provide: L, useClass: Xe }] });
} return t; })(), Ze = (() => { class t {
    static \u0275fac = function (n) { return new (n || t); };
...
function Nt() { return y(d.I18nSupport, Ge()); }
function kt() { return y(d.EventReplay, Ve()); }
function Ht() { return y(d.IncrementalHydration, Ye()); }
function Pt(...t) { let o = [], e = new Set; for (let { \u0275providers: r, \u0275kind: i } of t)
    e.add(i), r.length && o.push(r); let n = e.has(d.HttpTransferCacheOptions); return Fe([[], [], ze(), e.has(d.NoHttpTransferCache) || n ? [] : X({}), o]); }
var jt = new Je("21.2.6");
